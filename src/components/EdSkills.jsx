...
const EdSkill = () => {
  ...
  return (
    <div
      name="EdSkills"
      className="w-full  sm:py-[5%] bg-gradient-to-b from-gray-800 to-black text-white "
    >
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-6 gap-8 text-center py-8 px-12 sm:px-0">
          {skills.map(({ id, name, shadow, shadow1, style }) => {
            return (
              <div
                key={id}
                className={`shadow-md hover:scale-105 duration-500 py-2 rounded-lg ${shadow1}`}
              >
